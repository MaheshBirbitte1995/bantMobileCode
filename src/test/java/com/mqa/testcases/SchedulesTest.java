...
public class SchedulesTest extends BaseTest  {
	...
	@Test(priority = 1)
	public void Verify_create_Schedules() throws InterruptedException, IOException, AWTException {
		msg_inbox.Clickon_Menu_Icon();
		schedule.createSchedule();
		Assert.assertEquals("AppiumAutom"+schedule.random_schedule_name.trim(),schedule.created_schedule_on_datalist.getText().trim(),"Verification failed for created Schedules..!!");
